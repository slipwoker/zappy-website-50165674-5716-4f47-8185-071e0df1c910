document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if ((name === 'email' || input.type === 'email') && !validateEmail(value)) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            const inputs = contactForm.querySelectorAll('input:not([type="submit"]):not([type="hidden"]), textarea');
            let isValid = true;
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.matches('input, textarea') && input.type !== 'submit') {
                validateField(input);
            }
        });
        ...
        contactForm.addEventListener('blur', function(e) {
            const input = e.target;
            if (input.matches('input, textarea') && input.type !== 'submit' && input.value.trim()) {
                validateField(input);
            }
        }, true);
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '50165674-5716-4f47-8185-071e0df1c910',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '50165674-5716-4f47-8185-071e0df1c910';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '50165674-5716-4f47-8185-071e0df1c910';
